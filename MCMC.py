...
class RJMCMC_DoublyNeymanScott(DIGSNCP_base):
    ...
    # def simulate_cluster_transition_type(self, p_b):
    #     """
    ...
    #         else:
    #             return "move"
    #     elif u >= self.p_m and u < self.p_m+(1-self.p_m)*p_b: # Birth
    #         return "birth"
    #     elif u >= self.p_m+(1-self.p_m)*p_b: # Death
    #         return "death"
    #     else:
    #         assert False, "No transition proposal was made"
